...
require('lazy').setup({
    ...
    {                       -- Useful plugin to show you pending keybinds.
        ...
        opts = {
            ...
            spec = {
                ...
                { "<leader>w", group = "[W]orkspace/[W]indows" },
    ...
    },
    {
        ...
        dependencies = {
            ...
            -- Outline view for LSP symbols
            { "stevearc/aerial.nvim", opts = {}, dependencies = { "nvim-treesitter/nvim-treesitter", { "nvim-tree/nvim-web-devicons", enabled = vim.g.have_nerd_font } } },
        },
        config = function()
            ...
            vim.api.nvim_create_autocmd('LspAttach', {
                ...
                callback = function(event)
                    ...
                    -- Outline
                    map("go", "<cmd>AerialToggle!<cr>", "[C]ode [O]utline")
            ...
            vim.list_extend(ensure_installed, {
                ...
                'goimports',    -- Go import fixer/formatter
            })
    ...
    { -- Highlight, edit, and navigate code
        ...
        opts = {
            ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'python', 'yaml', 'go', 'gomod', 'gosum', 'gowork', 'json' },
