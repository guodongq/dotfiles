...
-- Set custom text width, as default is 80.
...
require('lazy').setup({
    ...
    { 'Bilal2453/luvit-meta', lazy = true },
    {
        ...
        dependencies = {
            ...
            -- Integration outline extensions
    ...
    { -- Highlight, edit, and navigate code
        ...
        opts = {
            ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'python', 'yaml', 'go', 'json' },
