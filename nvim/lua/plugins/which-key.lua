...
wk.setup({
    plugins = {
        ...
        presets = {
            operators = false, -- adds help for operators like d, y, ... and registers them for motion / text object lsp
...
local mappings = {
    ...
    b = {
        name = "Buffers",
        a = { "<cmd>lua require('Buffers').clear()<cr>", "delete-all-buffers" },
        d = { "<cmd>lua require('Buffers').delete()<cr>", "delete-this-buffer" },
        D = { "<cmd>lua require('Buffers').only()<cr>", "delete-other-buffers" },
    ...
    f = {
        ...
        o = { "<cmd>NvimTreeFindFile<cr>", "show-open-tree" },
    },
    g = {
        name = "Git",
