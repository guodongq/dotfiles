...
map("n", "gy",  action("editor.action.goToTypeDefinition"),        { desc = "[G]oto T[y]pe Definition" })
...
map({ "n", "x" }, "<leader>ca", action("editor.action.quickFix"),          { desc = "Code [A]ction" })
map("n",          "<leader>co", action("outline.focus"),                    { desc = "Code [O]utline" })
