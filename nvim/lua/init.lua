...
vim.keymap.set("n", "<leader>wd", "<cmd>wincmd c<cr>", { desc = "Window: [D]elete Current Window" })
vim.keymap.set("n", "<leader>wD", "<cmd>wincmd o<cr>", { desc = "Window: [D]elete Other Windows" })
vim.keymap.set("n", "<leader>wh", "<cmd>wincmd h<cr>", { desc = "Window: Goto Left Window" })
vim.keymap.set("n", "<leader>wj", "<cmd>wincmd j<cr>", { desc = "Window: Goto Down Window" })
vim.keymap.set("n", "<leader>wk", "<cmd>wincmd k<cr>", { desc = "Window: Goto Up Window" })
vim.keymap.set("n", "<leader>wl", "<cmd>wincmd l<cr>", { desc = "Window: Goto Right Window" })
vim.keymap.set("n", "<leader>ws", "<cmd>sp<cr>", { desc = "Window: [S]plit Window" })
vim.keymap.set("n", "<leader>wv", "<cmd>vsp<cr>", { desc = "Window: Split Window [V]ertically" })

-- Resize with arrows
vim.keymap.set("n", "<C-Up>", "<cmd>resize -2<CR>", { desc = "Shrink window vertically" })
vim.keymap.set("n", "<C-Down>", "<cmd>resize +2<CR>", { desc = "Increase window vertically" })
vim.keymap.set("n", "<C-Left>", "<cmd>vertical -2<CR>", { desc = "Shrink window horizontally" })
vim.keymap.set("n", "<C-Right>", "<cmd>vertical +2<CR>", { desc = "Increase window horizontally" })
...
require("lazy").setup({
    ...
    { -- Fuzzy Finder (files, lsp, etc)
        ...
        dependencies = {
            ...
            -- Project integration extensions
            {
                ...
                dependencies = {
                    -- optional, only for file_browser action
    ...
    { "Bilal2453/luvit-meta", lazy = true },
    {
        ...
        dependencies = {
            ...
            -- Code outline integration extensions
        ...
        config = function()
            ...
            vim.api.nvim_create_autocmd("LspAttach", {
                ...
                callback = function(event)
                    ...
                    -- code outline
                    map("<leader>co", "<cmd>AerialToggle float<cr>", "[C]ode [O]utline")
            ...
            require("mason-lspconfig").setup({
                handlers = {
                    function(server_name)
                        ...
                        local ok, custom_conf = pcall(require, "plugins.lsp." .. server_name)
                        if ok then
