...
vim.api.nvim_create_autocmd('TextYankPost', {
  ...
  group = vim.api.nvim_create_augroup('jarvis-highlight-yank', { clear = true }),
...
vim.api.nvim_create_autocmd('TermOpen', {
    group = vim.api.nvim_create_augroup('jarvis-term-open', { clear = true }),
...
vim.api.nvim_create_autocmd('BufReadPost', {
    group = vim.api.nvim_create_augroup('jarvis-buf-read-post', { clear = true }),
    callback = function(data)
